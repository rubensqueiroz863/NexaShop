    ...
    <div className="w-full">
      ...
      <div className="flex w-full gap-8 px-4 pt-4 md:pt-8 md:px-8">
        ...
        <div className="flex xl:flex-row flex-col gap-2 items-center flex-1 justify-center xl:px-34 md:px-12">
          <PhoneCategoryCard />
          <div className="flex xl:flex-col xl:h-74 xl:gap-4 xl:p-12 py-4 px-2 justify-between text-(--text-dark) w-full bg-(--bg-gray) rounded-2xl">
            {/* Free Shipping */}
            <div className="flex flex-row items-center gap-3">
              <svg width="28" height="28" className="text-(--primary-color) xl:w-10.5 xl:h-10.5" stroke="currentColor" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex flex-col justify-center">
                <p className="font-medium text-[13px] xl:text-[15px]">Free Shipping</p>
                <p className="text-(--text-muted) text-[12px] xl:text-[14px]">On All Orders</p>
              </div>
            </div>

            {/* Online Support */}
            <div className="flex flex-row items-center gap-3">
              <svg width="24" height="24" className="text-(--primary-color) xl:w-10 xl:h-10" stroke="currentColor" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex flex-col justify-center">
                <p className="font-medium text-[13px] xl:text-[15px]">Online Support</p>
                <p className="text-(--text-muted) text-[12px] xl:text-[14px]">Technical 24/7</p>
              </div>
            </div>
            ...
            <div className="flex flex-row items-center gap-3">
              ...
              <div className="flex flex-col justify-center">
                <p className="font-medium text-[13px] xl:text-[15px]">User Safety</p>
                <p className="text-(--text-muted) text-[12px] xl:text-[14px]">On All Orders</p>
              </div>
            </div>
          </div>
